...
const ViscousBubblesBackground = dynamic(
  () =>
    import("@/components/effects/ViscousBubblesBackground").then((mod) => ({ default: mod.ViscousBubblesBackground })),
  { ssr: false, loading: () => <div className="fixed inset-0 bg-black"></div> },
)
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      {/* Background de burbujas encima */}
      <ViscousBubblesBackground />
      ...
      <div className="relative z-10">
        ...
        <footer className="relative py-12 bg-black/80 border-t border-[#BBFF00]/20">
          <div className="container mx-auto px-4">
